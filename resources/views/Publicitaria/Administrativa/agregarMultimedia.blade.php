                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex justify-content-start">
                                    <h3 class="font-weight-bolder mb-0">Agregar Imagenes a la Publicacion {{$publicacion->titulo}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="formulario">
                            ...
                            <hr>
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="{{route('vistaAgrupacion',$publicacion->id_agrupacion)}}" class="btn btn-outline-success">Publicar</a>
                                </div>
