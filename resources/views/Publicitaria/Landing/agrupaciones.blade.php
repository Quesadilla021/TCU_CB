    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Agrupaciones</a></li>
        ...
        <section class="page-section" id="tituloAgrupacion">
            <div class="container">
                <div class="row">
                    <div class="col-3">
                            <img src="/imgPruebas/H1.png" class="rounded mx-auto d-block" alt="...">
                    </div>
                    <div class="col-9">
                        <h1 class="text-center mb-4">Titulo</h1>
                        <h4>Descripcion: Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
